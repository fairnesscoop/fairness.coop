...
Actuellement, le monde culturel et créatif est un grand consommateur de matériaux et d'objets utilisés pour la réalisation de scénographies ou l’aménagement d'expositions. Nombre de ces matériaux et objets sont achetés neufs. Après les événements, ces mêmes matériaux sont jetés ou, dans les meilleurs des cas, stockés.
...
Plinth est gratuit pour les donneurs, mais avec un abonnement (autour de 80 €/mois , variable en fonction des secteurs) pour ceux qui souhaitent récupérer gratuitement le matériel.
...
Nous nous appuierons sur un premier atelier destiné à élaborer ensemble le brief créatif. Nous travaillerons ensuite sur deux alternatives graphiques, intégrant UX (wireframes des principaux parcours utilisateurs) et UI
(design graphique), qui vous seront présentées sur la home page du site vitrine et une autre page clé déterminée ensemble (cela pourrait être la page “références”). 
...
Par rapport aux informations recueillies lors du premier atelier organisé avec Plinth, nous estimons que la durée de développement de Plinth (gestion des   annonces et hors gestion des stocks) sera autour de 50 jours ouvrés.
